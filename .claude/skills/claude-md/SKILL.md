---
name: claude-md
description: 建立、健檢、精簡 CLAUDE.md 。當使用者提到 CLAUDE.md、專案規則檔、instruction file，或說「幫我整理／檢查／瘦身／重寫規則檔」「Claude 一直忘記專案規則」「Claude 一直重複犯同樣的錯」「規則檔越來越肥」時，一定要使用這個 skill。剛跑完 /init 之後也要用這個 skill 做過濾。
---
